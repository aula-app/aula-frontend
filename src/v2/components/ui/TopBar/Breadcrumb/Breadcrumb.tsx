  ...
  return (
    ...
    >
      ...
      <div
        ...
        id="breadcrumb-menu"
        className={`absolute flex flex-col-reverse top-full bg-background text-foreground rounded-2xl rounded-tl-none max-w-sm shadow-sm border border-secondary p-1 z-50 transition-all duration-300 ease-out left-1/2 ${
