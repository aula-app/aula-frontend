...
const ALL_ICONS: Record<string, React.ComponentType<IconBaseProps>> = { ...ICONS, ...CAT_ICONS };

export type IconType = keyof typeof ICONS;
export type CategoryIconType = keyof typeof CAT_ICONS;
export type AllIconsType = keyof typeof ICONS | keyof typeof CAT_ICONS;

interface Props extends React.SVGAttributes<SVGElement> {
  type: AllIconsType; // Icon's name alternate prop
  size?: string | number;
}
