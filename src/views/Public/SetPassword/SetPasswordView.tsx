...
const SetPasswordView = () => {
  ...
  const [showPassword, setShowPassword] = useState<
    Record<keyof typeof fields, boolean>
  >({
  ...
  const validateCode = async () => {
    ...
    try {
      ...
      if (!isValid) {
        dispatch({
          type: "ADD_POPUP",
          message: { message: t("instance.error"), type: "error" },
        });
        navigate("/code");
      }
    } catch (err) {
  ...
  const validateKey = async () => {
    ...
    try {
      ...
      dispatch({
        type: "ADD_POPUP",
        message: { message: t("errors.default"), type: "error" },
      });
      setValid(false);
    }
  };
  ...
  const onSubmit = async (data: SchemaType) => {
    ...
    dispatch({
      type: "ADD_POPUP",
      message: { message: t("auth.password.success"), type: "success" },
    });
