  ...
  return (
    <Stack sx={{ padding: '20px 20px', overflow: 'auto' }}>
      ...
      <p>
        ...
        auf Anfrage, die für den Inhalt Verantwortlichen. Weiterhin können Texte, Bilder, Grafiken und sonstige Dateien
        ganz oder teilweise dem Urheberrecht Dritter unterliegen. Auch über das Bestehen möglicher Rechte Dritter geben
        Ihnen die für den Inhalt Verantwortlichen nähere Auskünfte. Der Nachdruck und die Auswertung von
