...
const AboutView = () => {
  ...
  return <Box sx={{ padding: '20px 20px'}}>
            <h2>Herausgeber:</h2>
            aula gGmbH
            <br/>
            ...
            <p>
            Die aula gGmbH ist beim Amtsregister Charlottenburg unter der Nummer 244593 B registriert.
            Vertreten durch: Alexa Schaegner (Geschäftsführung), Steffen Wenzel (Geschäftsführung)
            </p>
            ...
            <p>
            Steffen Wenzel (Anschrift siehe oben)
            </p>
